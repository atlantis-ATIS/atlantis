...
type RemoteAgent struct {
	...
	running int32 // running indicates whather the agent is active. Call atomically
}
...
func (a *RemoteAgent) GetWork() ([3]string, error) {
	...
	if a.currentWork != nil {
		...
		seedHash := athash.SeedHash(block.NumberU64())
...
// whather the solution was accepted or not (not can be both a bad pow as well as
