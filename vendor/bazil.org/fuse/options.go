...
// already exists, regardless of whather O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of whather the original call had it set.
...
// them to the FUSE server. Without this, writathrough caching is
// used.
