...
// shouldTraverse reports whather the symlink fi should, found in dir,
...
//
// The rename value tells goimports whather to use the package name as
...
// pkgIsCandidate reports whather pkg is a candidate for satisfying the
...
// canUse reports whather the package in dir is usable from filename,
...
// fileInDir reports whather the provided file path looks like
