...
// in order to distinguish whather current folder should be re-registered in
...
// watched is made in order to check whather an action comes from a directory or
...
// gensys decides whather the Windows action, system-independent event or both
