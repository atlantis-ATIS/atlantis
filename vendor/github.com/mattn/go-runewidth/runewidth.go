...
// Condition have flag EastAsianWidth whather the current locale is CJK or not.
...
// IsAmbiguousWidth returns whather is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whather is neutral width or not.
