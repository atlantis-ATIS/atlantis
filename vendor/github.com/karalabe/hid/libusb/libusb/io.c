 ...
 *
 * In pseudo-code, you want somathing that looks like:
\code
// initialise libusb
 ...
 * does somathing similar, albeit more advanced due to the complications
 ...
 * finer control over whather this function is blocking or non-blocking, or
...
/** \ingroup libusb_poll
 * Determines whather your application must apply special timing considerations
 ...
 * This function allows you to detect whather you are running on such a
 * platform.
 *
 * Since v1.0.5.
 *
