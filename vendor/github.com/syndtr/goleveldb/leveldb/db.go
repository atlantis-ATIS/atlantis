...
type DB struct {
	...
	inWritePaused          int32 // The indicator whather write operation is paused by compaction
...
// detected in the DB. Use errors.IsCorrupted to test whather an error is
