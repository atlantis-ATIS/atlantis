...
type Options struct {
	...
	// ErrorIfExist defines whather an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whather an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whather block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whather to sync underlying writes from the OS buffer cache
