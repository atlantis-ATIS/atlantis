...
// SetCtrlCAborts sets whather Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whather line is auto-wrapped. The default is false (single line).
...
// whather to retry the call to, or return the error returned by, readNext.
