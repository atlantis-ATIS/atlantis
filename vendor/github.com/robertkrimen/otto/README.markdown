...
Go translates JavaScript-style regular expressions into somathing that is
...
difficult to provide somathing like these via Go, but you probably want to wrap
