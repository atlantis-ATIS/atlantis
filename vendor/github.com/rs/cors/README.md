...
* `net/http`: [examples/nathttp/server.go](https://github.com/rs/cors/blob/master/examples/nathttp/server.go)
...
* **AllowCredentials** `bool`: Indicates whather the request can include user credentials like cookies, HTTP authentication or client side SSL certificates. The default is `false`.
