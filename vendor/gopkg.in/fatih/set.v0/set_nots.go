...
// IsEmpty reports whather the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test whather s and t are the same in size and have the same items.
...
// IsSubset tests whather t is a subset of s.
...
// IsSuperset tests whather t is a superset of s.
