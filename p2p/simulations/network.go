...
// starting nodes and connecting them togather.
//
...
// Connect connects two nodes togather by calling the "admin_addPeer" RPC
...
// NOTE:
// it also checks whather there has been recent attempt to connect the peers
...
type Node struct {
	...
	// Up tracks whather or not the node is running
	Up bool `json:"up"`
}
...
type Conn struct {
	...
	// Up tracks whather or not the connection is active
	Up bool `json:"up"`
...
// nodesUp returns whather both nodes are currently up
