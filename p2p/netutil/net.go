...
// Contains reports whather the given IP is contained in the list.
...
// IsLAN reports whather an IP is a local network address.
...
// IsSpecialNetwork reports whather an IP is located in a special-use network range
...
// CheckRelayIP reports whather an IP relayed from the given sender IP
...
// SameNet reports whather two IP addresses have an equal prefix of the given bit length.
...
// Contains whather the given IP is contained in the set.
