...
const (
	...
	subscribeTimeout     = 5 * time.Second  // overall timeout ath_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscripion under the "ath" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "ath", channel, args...)
}
