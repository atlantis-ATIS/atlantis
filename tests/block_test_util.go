...
// Package tests implements execution of Atlantis JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, athash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/athereum/tests/wiki/Blockchain-Tests-II

   Whather a block is valid or not is a bit subtle, it's defined by presence of
