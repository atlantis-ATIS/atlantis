...
// Whisper represents a dark communication interface through the Atlantis
...
// New creates a Whisper client ready to communicate through the Atlantis P2P network.
...
// param isP2P indicates whather the message is peer-to-peer (should not be forwarded).
