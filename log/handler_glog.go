...
type GlogHandler struct {
	...
	override  uint32 // Flag whather overrides are used, atomically accessible
	backtrace uint32 // Flag whather backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whather this is the callsite
