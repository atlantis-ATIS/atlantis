...
import (
	...
	"github.com/athereum/go-athereum/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*athapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx athapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*athapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := athapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
