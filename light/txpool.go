...
// to the ATH network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whather a transaction is valid according to the consensus rules.
