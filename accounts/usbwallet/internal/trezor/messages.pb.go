...
const (
	...
	MessageType_MessageType_AtlantisGetAddress       MessageType = 56
	MessageType_MessageType_AtlantisAddress          MessageType = 57
	MessageType_MessageType_AtlantisSignTx           MessageType = 58
	MessageType_MessageType_AtlantisTxRequest        MessageType = 59
	MessageType_MessageType_AtlantisTxAck            MessageType = 60
	...
	MessageType_MessageType_AtlantisSignMessage      MessageType = 64
	MessageType_MessageType_AtlantisVerifyMessage    MessageType = 65
	MessageType_MessageType_AtlantisMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_AtlantisGetAddress",
	57:  "MessageType_AtlantisAddress",
	58:  "MessageType_AtlantisSignTx",
	59:  "MessageType_AtlantisTxRequest",
	60:  "MessageType_AtlantisTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_AtlantisSignMessage",
	65:  "MessageType_AtlantisVerifyMessage",
	66:  "MessageType_AtlantisMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_AtlantisGetAddress":       56,
	"MessageType_AtlantisAddress":          57,
	"MessageType_AtlantisSignTx":           58,
	"MessageType_AtlantisTxRequest":        59,
	"MessageType_AtlantisTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_AtlantisSignMessage":      64,
	"MessageType_AtlantisVerifyMessage":    65,
	"MessageType_AtlantisMessageSignature": 66,
...
// *
// Request: Ask device for Atlantis address corresponding to address_n path
// @next PassphraseRequest
// @next AtlantisAddress
// @next Failure
type AtlantisGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *AtlantisGetAddress) Reset()                    { *m = AtlantisGetAddress{} }
func (m *AtlantisGetAddress) String() string            { return proto.CompactTextString(m) }
func (*AtlantisGetAddress) ProtoMessage()               {}
func (*AtlantisGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *AtlantisGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AtlantisGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Atlantis address derived from device private seed
// @prev AtlantisGetAddress
type AtlantisAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AtlantisAddress) Reset()                    { *m = AtlantisAddress{} }
func (m *AtlantisAddress) String() string            { return proto.CompactTextString(m) }
func (*AtlantisAddress) ProtoMessage()               {}
func (*AtlantisAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *AtlantisAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next AtlantisTxRequest
// @next Failure
type AtlantisSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *AtlantisSignTx) Reset()                    { *m = AtlantisSignTx{} }
func (m *AtlantisSignTx) String() string            { return proto.CompactTextString(m) }
func (*AtlantisSignTx) ProtoMessage()               {}
func (*AtlantisSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *AtlantisSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AtlantisSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *AtlantisSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *AtlantisSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *AtlantisSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *AtlantisSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *AtlantisSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *AtlantisSignTx) GetDataLength() uint32 {
...
func (m *AtlantisSignTx) GetChainId() uint32 {
...
func (m *AtlantisTxRequest) Reset()                    { *m = AtlantisTxRequest{} }
func (m *AtlantisTxRequest) String() string            { return proto.CompactTextString(m) }
func (*AtlantisTxRequest) ProtoMessage()               {}
func (*AtlantisTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *AtlantisTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *AtlantisTxRequest) GetSignatureV() uint32 {
...
func (m *AtlantisTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *AtlantisTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev AtlantisTxRequest
// @next AtlantisTxRequest
type AtlantisTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AtlantisTxAck) Reset()                    { *m = AtlantisTxAck{} }
func (m *AtlantisTxAck) String() string            { return proto.CompactTextString(m) }
func (*AtlantisTxAck) ProtoMessage()               {}
func (*AtlantisTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *AtlantisTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next AtlantisMessageSignature
// @next Failure
type AtlantisSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *AtlantisSignMessage) Reset()                    { *m = AtlantisSignMessage{} }
func (m *AtlantisSignMessage) String() string            { return proto.CompactTextString(m) }
func (*AtlantisSignMessage) ProtoMessage()               {}
func (*AtlantisSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *AtlantisSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *AtlantisSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type AtlantisVerifyMessage struct {
...
func (m *AtlantisVerifyMessage) Reset()                    { *m = AtlantisVerifyMessage{} }
func (m *AtlantisVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*AtlantisVerifyMessage) ProtoMessage()               {}
func (*AtlantisVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *AtlantisVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *AtlantisVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *AtlantisVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev AtlantisSignMessage
type AtlantisMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *AtlantisMessageSignature) Reset()                    { *m = AtlantisMessageSignature{} }
func (m *AtlantisMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*AtlantisMessageSignature) ProtoMessage()               {}
func (*AtlantisMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *AtlantisMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *AtlantisMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AtlantisGetAddress)(nil), "AtlantisGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*AtlantisAddress)(nil), "AtlantisAddress")
	...
	proto.RegisterType((*AtlantisSignTx)(nil), "AtlantisSignTx")
	proto.RegisterType((*AtlantisTxRequest)(nil), "AtlantisTxRequest")
	proto.RegisterType((*AtlantisTxAck)(nil), "AtlantisTxAck")
	proto.RegisterType((*AtlantisSignMessage)(nil), "AtlantisSignMessage")
	proto.RegisterType((*AtlantisVerifyMessage)(nil), "AtlantisVerifyMessage")
	proto.RegisterType((*AtlantisMessageSignature)(nil), "AtlantisMessageSignature")
