...
import (
	...
	"github.com/athereum/go-athereum/contracts/ens/contract"
	...
	"github.com/athereum/go-athereum/swarm/multihash"
...
func TestValidator(t *testing.T) {
	...
	key := rh.resourceHash(42, 1, ens.EnsNode("xyzzy.ath"))
	data := []byte("bar")
	uglyChunk := newUpdateChunk(key, nil, 42, 1, "xyzzy.ath", data, len(data))
	...
	key = rh.resourceHash(42, 2, ens.EnsNode("xyzzy.ath"))
	data = []byte("baz")
	uglyChunk = newUpdateChunk(key, nil, 42, 2, "xyzzy.ath", data, len(data))
