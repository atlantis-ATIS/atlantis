...
import (
	...
	"github.com/athereum/go-athereum/metrics/influxdb"
	"github.com/athereum/go-athereum/node"
	"github.com/athereum/go-athereum/p2p"
	"github.com/athereum/go-athereum/p2p/discover"
	"github.com/athereum/go-athereum/p2p/protocols"
	"github.com/athereum/go-athereum/p2p/simulations"
	"github.com/athereum/go-athereum/p2p/simulations/adapters"
	"github.com/athereum/go-athereum/rpc"
	"github.com/athereum/go-athereum/swarm/network"
	"github.com/athereum/go-athereum/swarm/state"
	whisper "github.com/athereum/go-athereum/whisper/whisperv5"
)
...
// matching of address hints; whather a message could be or is for the node
