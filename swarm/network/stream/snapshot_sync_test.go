...
import (
	...
	streamTesting "github.com/athereum/go-athereum/swarm/network/stream/testing"
	"github.com/athereum/go-athereum/swarm/pot"
...
func runSyncTest(chunkCount int, nodeCount int, live bool, history bool) error {
	...
	check := func(ctx context.Context, id discover.NodeID) (bool, error) {
		...
		for _, ch := range localChunks {
			...
			if *useMockStore {
				if globalStore == nil {
					return false, fmt.Errorf("Somathing went wrong; using mockStore enabled but globalStore is nil")
				}
