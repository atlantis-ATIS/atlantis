...
import (
	...
	"github.com/athereum/go-athereum/swarm/network/kademlia"
	"github.com/athereum/go-athereum/swarm/services/swap"
...
Timeout serves to indicate whather the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whather responder is expected to deliver content
