...
Newly created requests are satisfied bound togather in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state togather with an initial offset.
