...
import (
	...
	"github.com/athereum/go-athereum/contracts/chequebook"
	"github.com/athereum/go-athereum/contracts/ens"
	...
	"github.com/athereum/go-athereum/swarm/api"
	httpapi "github.com/athereum/go-athereum/swarm/api/http"
	"github.com/athereum/go-athereum/swarm/fuse"
	"github.com/athereum/go-athereum/swarm/network"
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := athclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := athclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
