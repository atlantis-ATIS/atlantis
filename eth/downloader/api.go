...
// Syncing provides information when this nodes starts synchronising with the Atlantis network and when it's finished.
...
type SyncingResult struct {
	...
	Status atlantis.SyncProgress `json:"status"`
}
