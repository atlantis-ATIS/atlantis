...
// returned from docker inspect, parsed into a form easily usable by puppath.
type containerInfos struct {
	running bool              // Flag whather the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whather there's a container running for the service
	...
	// Infos retrieved, parse the above into somathing meaningful
