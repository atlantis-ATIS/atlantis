...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Atlantis presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gath wallet import /path/to/my/presale.wallet

will prompt for your password and imports your ather presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Atlantis presale wallet",
				ArgsUsage: "<keyFile>",
...
betweenatlantis nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to anotheratlantis instance,
