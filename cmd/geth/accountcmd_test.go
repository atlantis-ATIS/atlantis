...
func TestAccountListEmpty(t *testing.T) {
	gath := runGath(t, "account", "list")
	gath.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	gath := runGath(t, "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	gath := runGath(t, "account", "new", "--lightkdf")
	defer gath.ExpectExit()
	gath.Expect(`
...
Your new account is locked with a password. Please give a password. Do not forget this password.
!! Unsupported terminal, password will be echoed.
Passphrase: {{.InputLine "somathing"}}
Repeat passphrase: {{.InputLine "somathing else"}}
...
func TestWalletImport(t *testing.T) {
	gath := runGath(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer gath.ExpectExit()
	gath.Expect(`
!! Unsupported terminal, password will be echoed.
...
// https://github.com/athereum/go-athereum/issues/1785
