...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *athdb.MemDatabase {
	var provers []func(key []byte) *athdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *athdb.MemDatabase {
		proof := athdb.NewMemDatabase()
