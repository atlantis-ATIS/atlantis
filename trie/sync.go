...
type request struct {
	...
	raw  bool        // Whather this is a raw entry (code) or a trie node
...
func (s *Sync) AddSubTrie(root common.Hash, depth int, parent common.Hash, callback LeafCallback) {
	...
	// If this sub-trie has a designated parent, link them togather
...
// Process injects a batch of retrieved trie nodes data, returning if somathing
...
func (s *Sync) Commit(dbw athdb.Putter) (int, error) {
...
func (s *Sync) children(req *request, object node) ([]*request, error) {
	// Gather all the children of the node, irrelevant whather known or not
	type child struct {
		node  node
		depth int
	}
