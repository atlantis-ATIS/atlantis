...
type DatabaseReader interface {
	...
	// Has retrieves whather a key is present in the database.
...
type Database struct {
	diskdb athdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb athdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch athdb.Batch) error {
