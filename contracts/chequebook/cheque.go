...
// Package chequebook package wraps the 'chequebook' Atlantis smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in ather; (auto)cashing cheques in ather
// as well as (auto)depositing ather to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/athereum/go-athereum/swarm/services/swap/swap"
)
...
// * depositing ather to the chequebook
// * watching incoming ather
...
// Cash cashes the cheque by sending an Atlantis transaction.
