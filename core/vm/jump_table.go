...
type operation struct {
	...
	halts   bool // indicates whather the operation should halt further execution
	jumps   bool // indicates whather the program counter should not increment
	writes  bool // determines whather this a state modifying operation
	valid   bool // indication whather the retrieved operation is valid and known
	reverts bool // determines whather the operation reverts state (implicitly halts)
	returns bool // determines whather the operations sets the return data content
}
