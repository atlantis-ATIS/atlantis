...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(athdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db athdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db athdb.Database, root common.Hash) error {
...
func checkStateConsistency(db athdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, athdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(athdb.Database), srcRoot)
