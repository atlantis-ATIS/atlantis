...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := athdb.NewMemDatabase()
	finalDb := athdb.NewMemDatabase()
...
// https://github.com/athereum/go-athereum/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(athdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(athdb.NewMemDatabase()))
...
// See https://github.com/athereum/go-athereum/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(athdb.NewMemDatabase()))
