...
type TxPoolConfig struct {
	NoLocals  bool          // Whather local transaction handling should be disabled
...
// validateTx checks whather a transaction is valid according to the consensus
...
// and returns whather it was inserted or an older was better.
//
// Note, this method assumes the pool lock is held!
...
func (pool *TxPool) addTxsLocked(txs []*types.Transaction, local bool) []error {
	...
	// Only reprocess the internal state if somathing was actually added
	if len(dirty) > 0 {
